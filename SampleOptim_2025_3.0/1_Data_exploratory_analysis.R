...
setwd("C:\\Users\\gonpa\\Documents\\WGBIOPTIM\\6Abril2025\\2025\\04.Meeting_Vignettes\\Vignettes\\SampleOptim") ##Set directory
output_dir<-"output/"
...
plot(data_samplebio$C_CLASSE,data_samplebio$MONTH, xlab="Length class", ylab="Month of sampling")
